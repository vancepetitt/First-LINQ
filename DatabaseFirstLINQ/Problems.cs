...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemFive()
        {
            ...
            var users = _context.Users.Where(d => d.RegistrationDate < DateTime.Parse("01/01/2016"));
            foreach (User user in users)
            {
        ...
        private void ProblemTen()
        {
            ...
            var employee = _context.UserRoles.Include(user => user.User).Where(user => user.Role.RoleName == "Employee").Select(user => user.User.Id);
        ...
        private void ProblemTwelve()
        {
            ...
            {
                Name = "Hasbro Gaming Rubik's Cube",
                Description = "Billions of combinations, one solution",
                Price = 9,
            };
        ...
        private void ProblemFourteen()
        {
            ...
            var productId = _context.Products.Where(p => p.Name == "Hasbro Gaming Rubik's Cube").Select(p => p.Id).SingleOrDefault();
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).SingleOrDefault();
        ...
        private void ProblemSixteen()
        {
            ...
            var product = _context.Products.Where(p => p.Name == "Nintendo Switch").SingleOrDefault();
            product.Price = 249;
